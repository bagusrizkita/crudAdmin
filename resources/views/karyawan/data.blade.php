...
<table class="table table-hover">
    ...
    <tbody>
      ...
      <td>{{ $k->alamat }}</td>
			<td>
				<a href="/pegawai/edit/{{ $k->id }}" class="btn btn-warning btn-sm">Edit</a>
				
				<a href="/pegawai/hapus/{{ $k->id }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?')">Hapus</a>
			</td>
        </tr>
    </tbody>
		@endforeach
